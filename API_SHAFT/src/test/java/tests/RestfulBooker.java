...
//import restfulbooker.objectModels.RestfulBookerApi;
import objectModels.RestfulBookerApi;
//import restfulbooker.objectModels.RestfulBookerApiBooking;
...
//        JSONFileManager testData = new JSONFileManager("testDataFiles/simpleJSON.json");
        String s = System.getProperty("searchQuery");
        System.out.println("****************");
        System.out.println((System.getProperty("testDataFolderPath") + "TestJsonFiles/RestfulBooker/booking.json"));
        System.out.println("********************************");
//        testData.getTestData("searchQuery");
//        driver = new SHAFT.GUI.WebDriver();
//        driver.browser().navigateToURL("https://www.google.co.uk/");
